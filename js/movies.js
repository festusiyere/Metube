...
let xhr = new XMLHttpRequest();
pages = 1;
xhr.open("GET", "https://api.themoviedb.org/3/search/movie?api_key=34ecbb288e9e94b508722abfc2597766&language=en-US&query="+this.value+"&page=1&include_adult=false");
xhr.onprogress = function(e) {
  otherbutton.style.display = "none";
  otherbutton1.style.display = "none";
  let me = document.querySelector('.movie-cards');
